...
export function EmployeesOrgChartDesktop({
  ...
  if (chart.director) {
    sections.push(
      <section
        className="org-chart__level org-chart__level--director"
        key="director"
      >
        <OrgLevelLabel
  ...
  if (chart.manager) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--manager"
        key="manager"
      >
        <OrgLevelLabel
          labelAr={t('employees.org.managersAr')}
          labelEn={t('employees.org.managersEn')}
        />
        <div className="org-chart__row org-chart__row--single">
          <OrgChartEmployeeCard
            employee={chart.manager}
            index={nextIndex()}
            size="executive"
          />
        </div>
  ...
  if (chart.assistantManagers.length > 0) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--assistant-managers"
        key="assistant-managers"
      >
        <OrgLevelLabel
  ...
  if (chart.seniorSupervisors.length > 0) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--senior"
        key="senior"
      >
        <OrgLevelLabel
  ...
  if (chart.leadSupervisors.length > 0) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--lead-supervisors"
        key="lead-supervisors"
      >
        <OrgLevelLabel
  ...
  if (chart.shiftLeaders.length > 0) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--shift-leaders"
        key="shift-leaders"
      >
        <OrgLevelLabel
  ...
  if (chart.tailor) {
    ...
    sections.push(
      <section
        className="org-chart__level org-chart__level--tailor"
        key="tailor"
      >
        <OrgLevelLabel
          labelAr={t('employees.org.tailorAr')}
          labelEn={t('employees.org.tailorEn')}
        />
        <div className="org-chart__row org-chart__row--single">
          <OrgChartEmployeeCard
            employee={chart.tailor}
            index={nextIndex()}
            size="standard"
          />
        </div>
  ...
  if (activeDepartments.length > 0) {
    ...
    sections.push(
      <section className="org-chart__level org-chart__level--staff" key="staff">
        <OrgLevelLabel
          labelAr={t('employees.org.staffAr')}
          labelEn={t('employees.org.staffEn')}
        />
          ...
          {activeDepartments.map((department) => (
            <div className="org-chart__department" key={department.id}>
              <div className="org-chart__department-header">
                <p className="org-chart__department-title-en">
                  {department.titleEn}
                </p>
                <p className="org-chart__department-title-ar">
                  {department.titleAr}
                </p>
              </div>
              <div
