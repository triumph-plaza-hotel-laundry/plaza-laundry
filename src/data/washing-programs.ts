...
export const washingPrograms: readonly WashingProgram[] = [
  {
    ...
    steps: [
      ...
      {
        step: 4,
        process: { en: 'First rinse', ar: 'شطفة أولى' },
        waterLevel: '2',
        temperature: cold,
      },
      {
        step: 5,
        process: { en: 'Second rinse', ar: 'شطفة ثانية' },
        waterLevel: '2',
        temperature: cold,
      },
      {
        step: 6,
        process: { en: 'Minor spin', ar: 'عصرة صغرى' },
        waterLevel: '-',
        temperature: dash,
      },
      {
        step: 7,
        process: { en: 'Third rinse', ar: 'شطفة ثالثة' },
        waterLevel: '2',
        temperature: cold,
      },
      {
        step: 8,
        process: { en: 'Sour', ar: 'ساور' },
        waterLevel: '1',
        temperature: cold,
      },
      {
        step: 9,
        process: { en: 'Final spin', ar: 'عصرة أخيرة' },
        waterLevel: '-',
        temperature: dash,
      },
    ],
  },
  {
    ...
    steps: [
      ...
      {
        step: 6,
        process: { en: 'Low spin', ar: 'عصرة صغرى' },
        waterLevel: '-',
        temperature: dash,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 8,
        process: { en: 'Soft + Sour', ar: 'سوفت + ساور' },
        waterLevel: '1',
        temperature: cold,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 2,
        process: { en: 'Wash', ar: 'غسيل' },
        waterLevel: '1',
        temperature: { en: '50', ar: '50' },
      },
      {
        step: 4,
        process: { en: 'First rinse', ar: 'شطفة أولى' },
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 6,
        process: { en: 'Small spin', ar: 'عصرة صغرى' },
        waterLevel: '-',
        temperature: dash,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 7,
        process: { en: 'Small spin/extraction', ar: 'عصرة صغرى' },
        waterLevel: '-',
        temperature: dash,
      },
      {
  ...
  },
  {
    ...
    steps: [
      ...
      {
        step: 3,
        process: { en: 'Final rinse', ar: 'شطفة أخيرة' },
        waterLevel: '2',
        temperature: cold,
      },
      {
