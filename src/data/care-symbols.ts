...
export type CareSymbolCategory = 'washing' | 'bleaching' | 'drying' | 'ironing' | 'dryCleaning';
export type CareSymbolGraphic = 'machine-wash' | 'hand-wash' | 'do-not-wash' | 'wash-cold' | 'wash-warm' | 'wash-hot' | 'gentle-cycle' | 'delicate-cycle' | 'bleach-allowed' | 'bleach-non-chlorine' | 'do-not-bleach' | 'tumble-dry' | 'tumble-low' | 'tumble-medium' | 'tumble-high' | 'hang-dry' | 'flat-dry' | 'drip-dry' | 'do-not-tumble' | 'iron-low' | 'iron-medium' | 'iron-high' | 'steam-iron' | 'do-not-iron' | 'dry-clean' | 'dry-clean-professional' | 'petroleum-solvent' | 'do-not-dry-clean';
...
function c(
  ...
  return {
    ...
    recommendedFabrics: { en: recommendedFabrics[0], ar: recommendedFabrics[1] },
...
export const careLabels: readonly CareLabel[] = [
  c(
    ...
    ['The garment may be washed in a commercial or domestic washing machine using the temperature and cycle indicated on the label.', 'يمكن غسل القطعة في غسالة تجارية أو منزلية وفق درجة الحرارة والبرنامج المحددين على البطاقة.'],
    ['1. Sort by colour, soil level, and fabric weight before loading.\n2. Select the Triumph Plaza Hotel program matching the care label temperature.\n3. Use Premium Main Wash Detergent at the dosage chart for load size.\n4. Avoid overloading — fill drum to 80% capacity maximum.\n5. Remove promptly after cycle completion to prevent creasing.', '1. فرّز حسب اللون ومستوى الاتساخ ووزن القماش قبل التحميل.\n2. اختر برنامج فندق تريومف بلازا المطابق لدرجة حرارة بطاقة العناية.\n3. استخدم منظف الغسيل الرئيسي الفاخر وفق جدول الجرعة لحجم الحمولة.\n4. تجنب الإفراط في التحميل — املأ الأسطوانة بحد أقصى 80%.\n5. أخرج القطعة فور انتهاء الدورة لمنع التجعد.'],
    ['Cotton bedsheets, polycotton uniforms, terry towels, table napkins, chef jackets', 'ملاءات قطنية، زي موحد من قطن مختلط، مناشف تيري، مناديل مائدة، سترات طهاة'],
    ['Check for loose buttons or trim before machine washing guest garments.\nNever mix chlorine bleach loads with coloured hotel linen.', 'افحص الأزرار أو الزخارف المفكوكة قبل الغسيل الآلي لملابس الضيوف.\nلا تخلط حمولات مبيض الكلور مع بياضات الفندق الملونة.'],
    ['Default symbol for 70% of Triumph Plaza bulk linen.\nRoute to Tunnel Washer Line 1 for sheets and Line 2 for towels.', 'الرمز الافتراضي لـ 70% من بياضات فندق تريومف بلازا بالجملة.\nوجّه لخط الغسالة النفقية 1 للملاءات والخط 2 للمناشف.'],
  ),
  ...
  c(
    ...
    'washing',
    ['Hand Wash', 'غسيل يدوي'],
    ['The garment requires gentle washing by hand in lukewarm water without mechanical agitation.', 'يتطلب القطعة غسلاً يدوياً لطيفاً في ماء فاتر دون تحريك ميكانيكي.'],
    ['1. Fill a clean basin with lukewarm water at 30°C maximum.\n2. Dissolve Delicate Fabric Wash at half the standard dosage.\n3. Submerge garment; gently squeeze — never wring or twist.\n4. Rinse in fresh cool water until detergent is fully removed.\n5. Roll in a clean towel to extract moisture; lay flat or hang to dry.', '1. املأ حوضاً نظيفاً بماء فاتر بحد أقصى 30°م.\n2. ذوّب منظف الأقمشة الحساسة بنصف الجرعة القياسية.\n3. اغمر القطعة؛ اضغط بلطف — لا تعصر أو تلف أبداً.\n4. اشطف بماء بارد نظيف حتى إزالة المنظف بالكامل.\n5. لفّ في منشفة نظيفة لامتصاص الرطوبة؛ جفّف مسطحاً أو معلقاً.'],
    ['Silk scarves, lace overlays, beaded evening wear, cashmere throws, designer guest garments', 'أوشحة حرير، تطريز دانتيل، ملابس سهرة مرصعة، أغطية كشمير، ملابس ضيوف مصممة'],
    ['Hand-wash only in the designated VIP garment bay — never in main wash sinks.\nDocument guest name and room number on every hand-wash tag.', 'الغسيل اليدوي فقط في منطقة ملابس كبار الشخصيات المخصصة — لا في أحواض الغسيل الرئيسية.\nسجّل اسم الضيف ورقم الغرفة على كل بطاقة غسيل يدوي.'],
    ['Train concierge to flag hand-wash items at collection.\nStock Delicate Fabric Wash at executive floor pantries.', 'درب الكونسيرج على تمييز قطع الغسيل اليدوي عند الاستلام.\nخزّن منظف الأقمشة الحساسة في مخازن الطابق التنفيذي.'],
  ),
  ...
  c(
    ...
    'washing',
    ['Do Not Wash', 'لا تغسل'],
    ['The garment must not be washed with water. Any aqueous cleaning will cause irreversible damage to fibres, dyes, or structure.', 'يجب عدم غسل القطعة بالماء. أي تنظيف مائي سيسبب ضرراً لا رجعة فيه للألياف أو الأصباغ أو البنية.'],
    ['1. Do not place in any washing machine or hand-wash basin.\n2. Inspect for surface soil; brush lightly with a soft garment brush only.\n3. Route immediately to approved dry-clean vendor with care label photo.\n4. Attach Do Not Wash tag and segregate in quarantine rack.\n5. Notify guest services before processing if item is guest-owned.', '1. لا تضع في أي غسالة أو حوض غسيل يدوي.\n2. افحص الاتساخ السطحي؛ فرش بلطف بفرشاة ملابس ناعمة فقط.\n3. وجّه فوراً لمزود التنظيف الجاف المعتمد مع صورة بطاقة العناية.\n4. أرفق بطاقة لا تغسل وافصل في رف الحجر الصحي.\n5. أبلغ خدمة الضيوف قبل المعالجة إن كانت القطعة ملكاً للضيف.'],
    ['Structured wool blazers, leather-trimmed coats, fur accessories, bonded laminates, some performance wear', 'سترات صوف منظمة، معاطف بحواف جلد، إكسسوارات فرو، طبقات ملصقة، بعض ملابس الأداء'],
    ['Water contact causes shrinkage, dye bleeding, and adhesive failure.\nNever attempt spot-cleaning with water on Do Not Wash labels.', 'ملامسة الماء تسبب انكماشاً ونزيف ألوان وفشل لاصق.\nلا تحاول إزالة البقع بالماء على بطاقات لا تغسل أبداً.'],
    ['Quarantine rack is mandatory at Triumph Plaza laundry intake.\nSLA: return to guest within 48 hours via contracted dry-clean partner.', 'رف الحجر الصحي إلزامي عند استلام غسيل تريومف بلازا.\nاتفاقية مستوى الخدمة: إرجاع للضيف خلال 48 ساعة عبر شريك التنظيف الجاف.'],
  ),
  ...
  c(
    ...
    ['The garment should be washed at a maximum temperature of 30°C to preserve colour, elasticity, and delicate fibres.', 'يجب غسل القطعة بدرجة حرارة لا تتجاوز 30°م للحفاظ على اللون والمرونة والألياف الحساسة.'],
    ['1. Set tunnel washer or washer-extractor to 30°C cold program.\n2. Use Colour-Safe Detergent — no alkali boosters.\n3. Pre-treat stains with cold Enzyme Prespot only.\n4. Select short or delicate cycle with reduced mechanical action.\n5. Cold rinse twice to remove all surfactant residue.', '1. اضبط الغسالة النفقية أو المستخرجة على برنامج بارد 30°م.\n2. استخدم منظفاً آمناً للألوان — دون معززات قلوية.\n3. عالج البقع بمُزيل إنزيمي بارد فقط.\n4. اختر دورة قصيرة أو حساسة بتحريك ميكانيكي مخفّض.\n5. اشطف بارد مرتين لإزالة بقايا المنظّف السطحي.'],
    ['Dark-coloured uniforms, navy concierge suits, printed resort wear, elastane blends, guest activewear', 'زي موحد داكن، بدلات كونسيرج كحلية، ملابس منتجع مطبوعة، خلطات إيلاستان، ملابس رياضية للضيوف'],
    ['Hot water causes dye migration on dark hotel uniforms.\nProtein stains (blood, egg) require cold pre-treatment before any warm step.', 'الماء الساخن يسبب انتقال ألوان على الزي الموحد الداكن.\nبقع البروتين (دم، بيض) تتطلب معالجة باردة قبل أي خطوة دافئة.'],
    ['Default for all dark uniform loads at Triumph Plaza.\nProgram code: COLD-30 on washer touch panels.', 'الافتراضي لجميع حمولات الزي الداكن في تريومف بلازا.\nرمز البرنامج: COLD-30 على لوحات الغسالة.'],
  ),
  ...
  c(
    ...
    ['The garment may be washed at 40°C — the standard temperature for everyday cotton and blended hotel textiles.', 'يمكن غسل القطعة عند 40°م — درجة الحرارة القياسية للقطن اليومي والمنسوجات الفندقية المختلطة.'],
    ['1. Load sorted whites and light colours together at 40°C.\n2. Dose Premium Main Wash Detergent per soil classification chart.\n3. Add Oxygen Bleach to white loads only at approved concentration.\n4. Run full wash cycle with intermediate rinse.\n5. Extract at high spin only if fabric care label permits.', '1. حمّل الأبيض والألوان الفاتحة المفرزة معاً عند 40°م.\n2. جرّع منظف الغسيل الرئيسي الفاخر وفق جدول تصنيف التربة.\n3. أضف مبيض الأكسجين لحمولات الأبيض فقط بالتركيز المعتمد.\n4. شغّل دورة غسيل كاملة مع شطف وسيط.\n5. استخرج بدوران عالٍ فقط إن سمحت بطاقة العناية.'],
    ['Polycotton pillowcases, housekeeping uniforms, spa robes, light-coloured table linen', 'أكياس وسائد من قطن مختلط، زي التدبير المنزلي، أردية سبا، مفارش مائدة فاتحة'],
    ['Do not exceed 40°C on garments with elastane content above 5%.\nSeparate heavily soiled chef coats — pre-soak before warm wash.', 'لا تتجاوز 40°م على الملابس التي تحتوي أكثر من 5% إيلاستان.\nافصل معاطف الطهاة شديدة الاتساخ — انقع قبل الغسيل الدافئ.'],
    ['Most common wash temperature across Triumph Plaza floors.\nAligns with Fine Cotton and Hotel Linen standard programs.', 'أكثر درجة حرارة غسيل شيوعاً في طوابق تريومف بلازا.\nيتوافق مع برامج قطن فاخر وبياضات فندقية القياسية.'],
  ),
  ...
  c(
    ...
    ['The garment may be washed at 60°C or higher for hygienic processing of white cotton and heavily soiled institutional linen.', 'يمكن غسل القطعة عند 60°م أو أعلى للمعالجة الصحية للقطن الأبيض وبياضات المؤسسات شديدة الاتساخ.'],
    ['1. Restrict to white 100% cotton or institutional polycotton only.\n2. Set tunnel washer to 60°C or 75°C Hygienic program.\n3. Dose Premium Main Wash Detergent plus Alkali Booster for heavy soil.\n4. Add Oxygen Bleach or approved chlorine for disinfection per HACCP protocol.\n5. Verify thermal disinfection log — hold 60°C for minimum 10 minutes.', '1. قيّد على القطن الأبيض 100% أو قطن مختلط مؤسسي فقط.\n2. اضبط الغسالة النفقية على برنامج صحي 60°م أو 75°م.\n3. جرّع منظف الغسيل الرئيسي الفاخر مع معزز قلوي للتربة الثقيلة.\n4. أضف مبيض أكسجين أو كلور معتمد للتعقيم وفق بروتوكول HACCP.\n5. تحقق من سجل التعقيم الحراري — حافظ على 60°م لمدة 10 دقائق كحد أدنى.'],
    ['White bedsheets, bath towels, kitchen cloths, medical-grade linen, post-event banquet napkins', 'ملاءات بيضاء، مناشف حمام، أقمشة مطبخ، بياضات طبية، مناديل حفلات بعد الفعاليات'],
    ['Never use 60°C+ on coloured, wool, silk, or synthetic garments.\nThermal damage to elastane is irreversible above 60°C.', 'لا تستخدم 60°م+ على الملون أو الصوف أو الحرير أو التركيبيات.\nالضرر الحراري للإيلاستان لا رجعة فيه فوق 60°م.'],
    ['Mandatory for banquet post-event linen reset at Triumph Plaza.\nHACCP thermal log required daily — Laundry Manager sign-off.', 'إلزامي لإعادة ضبط بياضات الحفلات بعد الفعاليات في تريومف بلازا.\nسجل حراري HACCP يومي — توقيع مدير الغسيل.'],
  ),
  ...
  c(
    ...
    ['The garment requires the most minimal mechanical action — typically for fragile knits, lace, and luxury fibres.', 'يتطلب القطعة أقل تحريك ميكانيكي ممكن — عادة للحياكات الهشة والدانتيل والألياف الفاخرة.'],
    ['1. Use dedicated Delicate & Silk program only — never standard cycles.\n2. Maximum load: 2 kg or three guest garments per cycle.\n3. Wash at 30°C with Delicate Fabric Wash — no bleach additives.\n4. Enable extra water fill for cushioning; disable pre-wash agitation.\n5. Air-dry or flat-dry only — do not tumble dry unless separately permitted.', '1. استخدم برنامج حساس وحرير المخصص فقط — لا الدورات القياسية.\n2. الحمولة القصوى: 2 كغ أو ثلاث قطع ضيوف لكل دورة.\n3. اغسل عند 30°م بمنظف الأقمشة الحساسة — دون إضافات مبيض.\n4. فعّل ملء ماء إضافي للتوسيد؛ عطّل تحريك ما قبل الغسيل.\n5. جفّف بالهواء أو مسطحاً فقط — لا تجفف بالمجفف إلا إن سُمح بذلك منفصلاً.'],
    ['Cashmere sweaters, silk pillowcases, lace curtains, fine knit guest loungewear', 'سترات كشمير، أكياس وسائد حرير، ستائر دانتيل، ملابس استرخاء ضيوف حياكة ناعمة'],
    ['Delicate cycle in a commercial machine still carries risk — escalate to hand-wash for couture items.\nNever combine delicates with terry towels in the same load.', 'الدورة الحساسة في آلة تجارية لا تزال محفوفة بالمخاطر — صعّد للغسيل اليدوي لقطع الكوتور.\nلا تخلط الحساس مع مناشف تيري في نفس الحمولة.'],
    ['Dedicated washer-extractor #4 in VIP bay — Delicate & Silk program locked.\nRequires senior laundry attendant authorization for each cycle.', 'مستخرجة مخصصة #4 في منطقة كبار الشخصيات — برنامج حساس وحرير مقفل.\nيتطلب تفويض مساعد غسيل أول لكل دورة.'],
  ),
  ...
  c(
    ...
    ['Chlorine or oxygen bleach may be used on this garment to whiten, disinfect, or remove stubborn stains.', 'يمكن استخدام مبيض الكلور أو الأكسجين على هذه القطعة للتبييض أو التعقيم أو إزالة البقع العنيدة.'],
    ['1. Confirm fabric is 100% white cotton or approved white polycotton.\n2. For chlorine: dose per chart — maximum 150 ppm active chlorine.\n3. For oxygen bleach: add at main wash stage at 40–60°C.\n4. Never pour undiluted bleach directly onto fabric.\n5. Rinse thoroughly — residual bleach damages fibres and causes yellowing over time.', '1. تأكد أن القماش قطن أبيض 100% أو قطن مختلط أبيض معتمد.\n2. للكلور: جرّع وفق الجدول — 150 جزء في المليون كلور نشط كحد أقصى.\n3. لمبيض الأكسجين: أضف عند مرحلة الغسيل الرئيسي عند 40–60°م.\n4. لا تسكب المبيض غير المخفف مباشرة على القماش.\n5. اشطف جيداً — بقايا المبيض تتلف الألياف وتسبب اصفراراً مع الوقت.'],
    ['White cotton bedsheets, white bath towels, white tablecloths, chef whites, kitchen aprons', 'ملاءات قطنية بيضاء، مناشف حمام بيضاء، مفارش مائدة بيضاء، بياضات طهاة، مآزر مطبخ'],
    ['Chlorine bleach on coloured fabric causes permanent colour loss.\nVentilation required — never mix bleach with acidic chemicals or ammonia.', 'مبيض الكلور على الأقمشة الملونة يسبب فقدان لون دائم.\nتهوية مطلوبة — لا تخلط المبيض مع مواد حمضية أو أمونيا.'],
    ['Oxygen Bleach preferred for daily white linen at Triumph Plaza.\nChlorine reserved for post-outbreak hygienic resets only.', 'مبيض الأكسجين مفضل لبياضات الأبيض اليومية في تريومف بلازا.\nالكلور محجوز لإعادة الضبط الصحي بعد التفشي فقط.'],
  ),
  ...
  c(
    ...
    ['The garment may be tumble dried on high heat — typically for durable white cotton that tolerates thermal finishing.', 'يمكن تجفيف القطعة في المجفف بحرارة عالية — عادة للقطن الأبيض المتين الذي يتحمل التشطيب الحراري.'],
    ['1. Restrict to 100% white cotton towels and institutional linen only.\n2. Set dryer to High Heat — maximum 75°C drum temperature.\n3. Run to full dryness for hygienic storage compliance.\n4. Cool-down phase minimum 5 minutes before unload.\n5. Inspect for scorch marks on hem folds — reduce heat if yellowing appears.', '1. قيّد على مناشف قطنية بيضاء 100% وبياضات مؤسسية فقط.\n2. اضبط المجفف على حرارة عالية — 75°م درجة أسطوانة كحد أقصى.\n3. جفّف بالكامل للامتثال للتخزين الصحي.\n4. مرحلة تبريد 5 دقائق كحد أدنى قبل التفريغ.\n5. افحص علامات احتراق على طيات الحواف — قلّل الحرارة إن ظهر اصفرار.'],
    ['White bath towels, kitchen terry cloths, mop heads, heavy-duty pool towels', 'مناشف حمام بيضاء، أقمشة تيري مطبخ، رؤوس ممسحات، مناشف مسبح ثقيلة'],
    ['High heat permanently damages all synthetics, wool, and silk.\nScorch risk on folded hems — do not overload drum.', 'الحرارة العالية تتلف جميع التركيبيات والصوف والحرير نهائياً.\nخطر احتراق على طيات الحواف — لا تفرط في تحميل الأسطوانة.'],
    ['High-heat dryers restricted to towel tunnel only at Triumph Plaza.\nGuest garments are never processed on high heat — policy violation.', 'مجافف الحرارة العالية مقيدة بأنفاق المناشف فقط في تريومف بلازا.\nملابس الضيوف لا تُعالج أبداً بحرارة عالية — مخالفة سياسة.'],
  ),
  ...
  c(
    ...
    ['The garment must not be placed in a tumble dryer. Heat and mechanical action will cause shrinkage, melting, or permanent damage.', 'يجب عدم وضع القطعة في مجفف دوّار. الحرارة والتحريك الميكانيكي يسببان انكماشاً أو ذوباناً أو ضرراً دائماً.'],
    ['1. Remove from washer immediately — do not allow crease setting in damp bundle.\n2. Shake out and hang-dry or flat-dry per companion care symbols.\n3. Block access to tumble dryers for tagged items at finishing station.\n4. If accidentally tumbled, inspect for heat damage before returning to guest.\n5. Document incident and notify Laundry Manager for guest-owned items.', '1. أخرج من الغسالة فوراً — لا تسمح بتثبيت التجاعيد في حزمة رطبة.\n2. هزّ وعلّق للتجفيف أو جفّف مسطحاً وفق رموز العناية المرافقة.\n3. احجب الوصول للمجافف للقطع الموسومة عند محطة التشطيب.\n4. إن جُففت بالمجفف بالخطأ، افحص ضرر الحرارة قبل الإرجاع للضيف.\n5. وثّق الحادث وأبلغ مدير الغسيل لقطع الضيوف المملوكة.'],
    ['Wool coats, silk dresses, rubber-backed mats, pleated uniforms, flame-retardant drapes', 'معاطف صوف، فساتين حرير، سجاد بظهر مطاطي، زي مطوي، ستائر مقاومة للهب'],
    ['A single tumble cycle can shrink wool by two sizes irreversibly.\nRubber-backed items melt and contaminate dryer drums.', 'دورة مجفف واحدة قد تنكمش الصوف مقاسين لا رجعة فيه.\nالقطع بظهر مطاطي تذوب وتلوث أسطوانات المجفف.'],
    ['Red No-Tumble tags at Triumph Plaza finishing intake — mandatory scan.\nGuest garment accident protocol: full compensation review by Front Office.', 'بطاقات حمراء لا مجفف عند استلام التشطيب في تريومف بلازا — مسح إلزامي.\nبروتوكول حادث ملابس الضيف: مراجعة تعويض كاملة من الاستقبال.'],
  ),
  ...
  c(
    ...
    ['The garment may be refreshed with steam without direct soleplate contact, or ironed with full steam assist.', 'يمكن تجديد القطعة بالبخار دون ملامسة مباشرة للصفيحة، أو كيها بمساعدة بخار كاملة.'],
    ['1. Use professional steam finishing cabinet or hand steamer for guest garments.\n2. Hold steamer head 2–3 cm from fabric — never touch embellishments.\n3. Steam from top to bottom; smooth with hand inside garment for shape.\n4. For steam-iron combo: set appropriate heat dot plus maximum steam.\n5. Allow 5-minute set time before bagging — residual moisture causes mildew in garment bags.', '1. استخدم خزانة تشطيب بخار مهنية أو مبخر يدوي لملابس الضيوف.\n2. أبقِ رأس المبخر 2–3 سم من القماش — لا تلمس الزخارف.\n3. بخّر من الأعلى للأسفل؛ نعّم باليد داخل القطعة للشكل.\n4. لكي-بخار مجتمع: اضبط نقطة الحرارة المناسبة مع أقصى بخار.\n5. اسمح بـ 5 دقائق للتثبيت قبل التغليف — الرطوبة المتبقية تسبب عفن في أكياس الملابس.'],
    ['Wool suiting, velvet banquet chairs covers (removable), draped dresses, crushed linen resort wear', 'بدلات صوف، أغطية كراسي حفلات مخملية (قابلة للإزالة)، فساتين منسدلة، ملابس منتجع كتان مجعد'],
    ['Steam alone does not remove oil-based stains — pre-treat before steaming.\nVelvet must be steamed from reverse only — front steaming flattens pile permanently.', 'البخار وحده لا يزيل بقع الزيت — عالج مسبقاً قبل التبخير.\nالمخمل يُبخر من الخلف فقط — التبخير الأمامي يسطح الوبر نهائياً.'],
    ['Steam finishing cabinet in VIP bay — primary tool for guest suit recovery.\nBanquet velvet covers steamed between events — 15-minute turnaround.', 'خزانة تشطيب بخار في منطقة كبار الشخصيات — الأداة الأساسية لاستعادة بدلات الضيوف.\nأغطية مخمل الحفلات تُبخر بين الفعاليات — 15 دقيقة دورة.'],
  ),
  ...
  c(
    ...
    ['The garment requires professional dry cleaning with specialist handling — not in-house or standard batch processing.', 'يتطلب القطعة تنظيفاً جافاً مهنياً بمعالجة متخصصة — ليس معالجة داخلية أو دفعية قياسية.'],
    ['1. Flag as Professional at intake — escalate to Laundry Manager immediately.\n2. Complete specialist garment form: fibre, trim, stain map, and guest priority tier.\n3. Dispatch to Tier-1 couture vendor — never standard batch dry clean.\n4. Request hand-finish pressing and padded hanger return.\n5. Insurance documentation for items valued above hotel liability threshold.', '1. علّم كمهني عند الاستلام — صعّد لمدير الغسيل فوراً.\n2. أكمل نموذج قطعة متخصصة: ألياف، زخارف، خريطة بقع، وفئة أولوية الضيف.\n3. أرسل لمزود كوتور من المستوى الأول — لا تنظيف جاف دفعي قياسي.\n4. اطلب كي تشطيب يدوي وإرجاع بعلاقة مبطنة.\n5. وثائق تأمين للقطع التي تتجاوز حد مسؤولية الفندق.'],
    ['Couture evening gowns, fur-trimmed coats, beaded jackets, bespoke suiting, archival uniform pieces', 'فساتين سهرة كوتور، معاطف بحواف فرو، سترات مرصعة، بدلات مفصلة حسب الطلب، قطع زي أرشيفية'],
    ['Standard dry clean damages beading adhesive and fur skin backing.\nNever store professional items in plastic — breathable garment bag only.', 'التنظيف الجاف القياسي يتلف لاصق الترتر وظهر جلد الفرو.\nلا تخزّن القطع المهنية في بلاستيك — كيس ملابس قابل للتنفس فقط.'],
    ['Tier-1 vendor: Atelier Prestige — dedicated account for Triumph Plaza VIP events.\nGM approval required for items exceeding USD 5,000 declared value.', 'مزود المستوى الأول: أتيليه بريستيج — حساب مخصص لفعاليات كبار الشخصيات في تريومف بلازا.\nموافقة المدير العام مطلوبة للقطع التي تتجاوز 5000 دولار قيمة مُعلنة.'],
  ),
  ...
  c(
    ...
    ['The garment must not be dry cleaned. Solvents will dissolve coatings, swell fibres, or destroy waterproof and bonded constructions.', 'يجب عدم التنظيف الجاف للقطعة. المذيبات ستذيب الطلاءات أو تنتفخ الألياف أو تدمر البنى المقاومة للماء والملصقة.'],
    ['1. Process via approved aqueous wash method only — match wash symbol on label.\n2. Do not dispatch to dry-clean vendor under any circumstance.\n3. If soil level exceeds aqueous capability, consult manufacturer care sheet.\n4. Guest consultation mandatory before processing high-value Do Not Dry Clean items.\n5. Document alternative care path on garment ticket for liability protection.', '1. عالج بطريقة الغسيل المائي المعتمدة فقط — طابق رمز الغسيل على البطاقة.\n2. لا ترسل لمزود التنظيف الجاف تحت أي ظرف.\n3. إن تجاوز مستوى الاتساخ قدرة الغسيل المائي، راجع ورقة عناية المصنع.\n4. استشارة الضيف إلزامية قبل معالجة قطع عالية القيمة لا تنظيف جاف.\n5. وثّق مسار العناية البديل على تذكرة القطعة لحماية المسؤولية.'],
    ['Gore-Tex outerwear, PVC-coated aprons, latex-backed curtains, some athletic performance wear', 'ملابس خارجية غور-تكس، مآزر مطلية PVC، ستائر بظهر لاتكس، بعض ملابس الأداء الرياضي'],
    ['Dry-clean solvent strips DWR (durable water repellent) coatings permanently.\nPVC and rubber components crack and peel after solvent exposure.', 'مذيب التنظيف الجاف يزيل طلاءات DWR (طارد الماء المتين) نهائياً.\nمكونات PVC والمطاط تتشقق وتتقشر بعد التعرض للمذيب.'],
    ['Do Not Dry Clean items routed to specialist aqueous outerwear program.\nPool attendant uniforms — in-house wash only, never vendor dry clean.', 'قطع لا تنظيف جاف تُوجّه لبرنامج ملابس خارجية مائي متخصص.\nزي منسقي المسبح — غسيل داخلي فقط، لا تنظيف جاف لدى المزود أبداً.'],
  ),
];
