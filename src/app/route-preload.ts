const routePreloaders: Record<string, () => Promise<unknown>> = {
  ...
  '/admin/inventory': () => import('@/features/admin/pages/AdminInventoryEditorPage'),
  '/admin/employees': () => import('@/features/admin/pages/AdminEmployeesEditorPage'),
  '/admin/shifts': () => import('@/features/admin/pages/AdminShiftsEditorPage'),
  '/admin/leaves': () => import('@/features/admin/pages/AdminLeavesPage'),
  '/admin/price-list': () => import('@/features/admin/pages/AdminPriceListEditorPage'),
  '/admin/chemicals': () => import('@/features/admin/pages/AdminChemicalsEditorPage'),
  '/admin/fabrics': () => import('@/features/admin/pages/AdminFabricsEditorPage'),
  '/admin/stains': () => import('@/features/admin/pages/AdminStainsEditorPage'),
  '/admin/programs': () => import('@/features/admin/pages/AdminProgramsEditorPage'),
  '/admin/care-symbols': () => import('@/features/admin/pages/AdminCareSymbolsEditorPage'),
  '/admin/training': () => import('@/features/admin/pages/AdminTrainingEditorPage'),
  '/admin/home': () => import('@/features/admin/pages/AdminHomeContentEditorPage'),
