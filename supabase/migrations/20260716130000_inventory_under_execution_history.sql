...
-- App must INSERT only; never UPDATE or DELETE this table.
...
-- Read + append only (no update/delete policies → immutable via anon client)
...
-- One-time backfill: archive any existing active Under Execution rows
